...
CALL bootstrap.bat
b2 install toolset=%TOOLSET% variant=release,debug link=shared threading=multi address-model=%ADRESSMODEL% --prefix=%ROOT_DIR%\third-party\libboost --without-python --stagedir=./stage
